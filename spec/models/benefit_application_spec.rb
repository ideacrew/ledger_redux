...
RSpec.describe BenefitApplication, type: :model do
  ...
  context "Given all valid params" do
    it "should create a new instance" do 
      Commands::BenefitApplication::Create.call(hbx_id: hbx_id, fein: fein, legal_name: legal_name, dba: dba, metadata: metadata)
      expect(BenefitApplication.first!.fein).to eq fein
    end

    it "should update the fein attribute" do
      Commands::BenefitApplication::UpdateFein.call(hbx_id: hbx_id, fein: updated_fein, metadata: {})
