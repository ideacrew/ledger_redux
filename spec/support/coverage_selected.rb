{:enrollment_event=>
  {:header=>{:hbx_id=>"DC0", :submitted_timestamp=>"2020-08-21T14:01:39"},
   :event=>
    {:body=>
        ...
        {:affected_members=>
          {:affected_member=>
            {:member=>
              {:id=>
                {:id=>
                  "urn:openhbx:hbx:dc0:resources:v1:person:hbx_id#20021233"},
             ...
             :is_subscriber=>"true",
             :benefit=>{:premium_amount=>"518.8", :begin_date=>"20200901"}}},
             ...
             :enrollees=>
              {:enrollee=>
                {:member=>
                 ...
                 :is_subscriber=>"true",
                 :benefit=>
                  {:premium_amount=>"518.8", :begin_date=>"20200901"}}},
             :enrollment=>
              {:plan=>
                {:id=>{:id=>"86052DC0460011-01"},
                 ...
                 :carrier=>{:id=>{:id=>"116036"}, :name=>"CareFirst"},
                 :metal_level=>
                  "urn:openhbx:terms:v1:plan_metal_level#platinum",
                 :coverage_type=>
               ...
               :eligibility_event=>
                {:event_kind=>
                  "urn:dc0:terms:v1:qualifying_life_event#open_enrollment"}},
